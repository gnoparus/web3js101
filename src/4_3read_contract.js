...
async function main() {
    ...
    // // Contract functions
    var contract_name;
    contract.methods.name().call((err, result) => { contract_name = result; console.log("contract_name ", contract_name) })
    var contract_symbol;
    contract.methods.symbol().call().then((result) => { contract_symbol = result; console.log("contract_symbol ", contract_symbol) })
    var totalSupply;
    contract.methods.totalSupply().call().then((result) => { totalSupply = web3.utils.fromWei(result, "ether"); console.log("totalSupply ", totalSupply) })
